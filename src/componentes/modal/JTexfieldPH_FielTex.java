...
public class JTexfieldPH_FielTex extends JTextField {
  ...
  public JTexfieldPH_FielTex() {
    ...
    getDocument().addDocumentListener(new DocumentListener() {
          public void removeUpdate(DocumentEvent e) {
            JTexfieldPH_FielTex.this.band = !(JTexfieldPH_FielTex.this.getText().length() > 0);
          }
          
          public void insertUpdate(DocumentEvent e) {
            JTexfieldPH_FielTex.this.band = false;
          }
